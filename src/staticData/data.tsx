import { DemoObjType, SkillObjType, ProjectObjType, CertificateObjType, ComponentObjType, ArticleObjType, StatisticObjType } from "./types"

export const demos: Array<DemoObjType> = [
    { title: "ChatGPT Babür", description: "OpenAI, Node.js, Express.js React.js, Antd, TypeScript", link: "https://babur.vercel.app/", code: "https://github.com/Hakan-unal/babur" },
    ...
    { title: "Poems Creator with QR Code", description: "React.js, Antd, TypeScript", link: "https://poems-one.vercel.app/", code: "https://github.com/Hakan-unal/poems" },
