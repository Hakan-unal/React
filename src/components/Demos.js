        ...
        <Row className="mt-5 mx-3">
          ...
          >
            <Card style={cardPadding}>
              ...
              <Card.Body>
                ...
                <hr />
                <Card.Text>
                  React.js, Canvas application
                </Card.Text>
                <Button
                  variant="outline-primary"
                  href="https://flowers-tau.vercel.app/"
                >
                  Demo
                </Button>
              </Card.Body>
          ...
          >
            <Card style={cardPadding}>
              ...
              <Card.Body>
                ...
                <Button
                  variant="outline-primary"
                  href="https://soundbox-puce.vercel.app/"
                >
                  Demo
                </Button>
              </Card.Body>
          ...
          >
            <Card style={cardPadding}>
              <Card.Img width={100} height={150} variant="top" src={vercel} />
              <Card.Body>
                <Card.Title>Stefan Zweig Books</Card.Title>
                <hr />
                <Card.Text>
                  React.js application
                </Card.Text>
                <Button
                  variant="outline-primary"
                  href="https://zweig-books.vercel.app/"
                >
                  Demo
                </Button>
              </Card.Body>
          ...
          >
            <Card style={cardPadding}>
              ...
              <Card.Body>
                ...
                <Button
                  variant="outline-primary"
                  href="https://valentine-nu.vercel.app/"
                >
                  Demo
                </Button>
              </Card.Body>
